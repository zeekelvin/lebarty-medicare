...
export const metadata: Metadata = {
  ...
  description:
    "Wellness visits, age-appropriate screenings, lab work, and women's and men's health with Dr. Nosa Lebarty, MD, all coordinated as one continuous primary-care plan.",
...
const content: ServiceContent = {
  ...
  intro:
    "Annual wellness, screenings calibrated to your age and history, lab work, and women's and men's health, all coordinated as part of one continuous primary-care plan. Preventive care is the quiet work that keeps small concerns from becoming serious ones.",
  heroImage: assets.pages.preventiveCare,
  overviewTitle: "Health you can stay ahead of.",
  overview: [
    "Most of the conditions that affect adults the most, including heart disease, diabetes, and several cancers, give early signals long before they cause symptoms. Preventive care is how those signals get noticed in time. A yearly wellness visit, the right screenings, and routine lab work together build a picture of your health that updates year after year.",
  ...
  faqs: [
    ...
    {
      q: "How much does preventive care cost?",
      a: "Wellness visits and screenings are priced clearly, and several are bundled into the prepaid care packages. The front desk can confirm current rates and any HMO cover before you book.",
    },
    {
  ...
  related: [
    ...
    {
      title: "Laboratory",
      body: "Blood work, urinalysis, and diagnostic testing on site, with results explained plainly and folded into your plan.",
