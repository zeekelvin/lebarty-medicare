...
export const metadata: Metadata = {
  ...
  description:
    "Secure video visits across New York with Dr. Nosa Lebarty, MD. Same physician, same chart, scheduled around your life. Most insurance accepted.",
  alternates: { canonical: "/services/telehealth" },
};

const content: ServiceContent = {
  eyebrow: "Telehealth · Across New York",
  title: "Care that travels with you.",
  intro:
    "Real visits, on video, with the same physician you would see in person. Telehealth works well for follow-ups, refills, addiction-medicine check-ins, urgent questions, and anything that does not require a hands-on exam — without the drive, the parking, or the waiting room.",
  ...
  overview: [
    ...
    "Visits run on a HIPAA-secure video connection, and you do not need to install a special app — a phone, tablet, or computer with a camera is enough. New York insurers generally reimburse telehealth at parity with in-office visits, so cost is rarely a barrier.",
  ...
  expect: [
    "HIPAA-secure video — no special app required",
    "Available to patients across New York State",
    "Most insurance reimburses telehealth at parity with office visits",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "In most cases, yes. New York insurers generally reimburse telehealth at the same rate as in-office visits. Call the office if you want to confirm your specific plan.",
    },
    {
      q: "Can I start or continue Suboxone on telehealth?",
      a: "Yes. New York permits telehealth induction and ongoing buprenorphine visits, so addiction-medicine care can begin and continue by video.",
    },
    {
      q: "Where do I need to be for a telehealth visit?",
      a: "You should be physically located in New York State and somewhere private with a stable connection — home, work, or anywhere you can talk freely.",
    },
  ],
  related: [
    {
